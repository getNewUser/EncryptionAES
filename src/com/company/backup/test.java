...
public class test {
    ...
    public static void main(String[] args) {
        File inputFile = new File("C:\\Users\\80085\\Desktop\\folder\\carrot-cake.jpg");
        File outputFile = new File("C:\\Users\\80085\\Desktop\\folder\\decrypted.txt");
        try {
...
//        try {
//            encrypt("mykey", IV,"C:\\Users\\80085\\Desktop\\folder\\carrot-cake.jpg");
//      //     decrypt("mykey",IV,"C:\\Users\\80085\\Desktop\\folder\\new.aes");
//        } catch (Exception e) {
...
//        }
    ...
    public void encryptDirectory(File file) {
        try{
    ...
    public static void test_encrypt_decrypt() throws Exception {
        ...
        String s = readFile("C:\\Users\\80085\\Desktop\\folder\\big.txt");
        ...
        writer = new PrintWriter("out2.aes", "UTF-8");
        writer.print(res);
        writer.close();
    }
